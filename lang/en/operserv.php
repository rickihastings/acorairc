...
$help = (object) array(
	...
	'OS_HELP_STATS_ALL' 		=> array(
		...
		'Syntax: STATS',
		' ',
		'Shows the current number of users online, channels',
		'open, the length of time the services has been running,',
		'and some memory usage information.',
		' ',
		'Command limited to IRC Operators.',
		'=---- End of OperServ Help ----=',
	),
	...
	// vhosts
	'OS_STATS_1'		=> 'Statistics for {network}:',
	'OS_STATS_2'		=> '      Version: {version}',
	'OS_STATS_3'		=> '    Max users: {users}',
	'OS_STATS_4'		=> 'Current users: {users}',
	'OS_STATS_5'		=> 'Current chans: {chans}',
	'OS_STATS_6'		=> '       Uptime: {time}',
	'OS_STATS_7'		=> ' Memory usage: {memory} ({real} bytes)',
	'OS_STATS_8'		=> 'Incoming data: {memory} ({real} bytes)',
	'OS_STATS_9'		=> 'Outgoing data: {memory} ({real} bytes)',
	// stats
