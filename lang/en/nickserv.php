...
$help = (object) array(
	...
	'NS_HELP_IDENTIFY_ALL' 	=> array(
		...
		' ',
		'You can identify for nicknames other than the one you are',
		'using by adding a nickname before your password. If no nick',
		'is entered your current nickname will be used.',
		'=---- End of {nickserv} Help ----=',
	),
	// IDENTIFY
	...
	'NS_NOT_IDENTIFIED'		=>	'You are not logged in',
	...
	'NS_FLAGS_INVALID_S'	=>	'The value for {flag} must be higher than 5 seconds and lower than {limit}.',
