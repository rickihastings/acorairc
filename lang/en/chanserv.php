...
$help = (object) array(
	...
	'CS_FLAGS_d' => '    +d - Changes or unsets the channel description.',
	'CS_FLAGS_u' => '    +u - Associates a url with the channel.',
	'CS_FLAGS_e' => '    +e - Associates an email address with the channel.',
	'CS_FLAGS_w' => array( '    +w - Sets or unsets a welcome message for the channel, this will',
						   '         be noticed to all users joining the channel.' ),
	'CS_FLAGS_m' => array( '    +m - Allows a set of modes to be locked with this flag. Note that.',
						   '         unlike flags, the parameter for this will REPLACE the existing',
						   '         modelock, not append or change them.' ),
	'CS_FLAGS_t' => array( '    +t - Sets a topic mask which may be used with the TOPIC or !topic',
						   '         commands, the topicmask must contain a wildcard (*).' ),
	'CS_FLAGS_S' => array( '    +S - Enables channel security features, which means a nickname must',
						   '         be registered and identified to gain access on the channel,',
						   '         things like +v *!*@* will stop working with this on.' ),
	'CS_FLAGS_F' => array( '    +F - Enables channel fantasy commands, which allows use of in-channel',
						   '         commands such as !op/!deop.' ),
	'CS_FLAGS_G' => array( '    +G - If enabled {chanserv} will occupy your channel, +F won\'t work',
						   '         without this enabled.' ),
	'CS_FLAGS_T' => array( '    +T - Prevents channel ops from changing the topic. This can be',
						   '         overriden with TOPIC or !topic.' ),
	'CS_FLAGS_K' => array( '    +K - Saves the topic when it changes. Saved topics are restored when',
						   '         the channel has been recreated.' ),
	'CS_FLAGS_L' => array( '    +L - Enables auto-limit, updates the channel limit at regular intervals',
						   '         to keep a certain number of free spaces. This can prevent join floods.' ),
	'CS_FLAGS_I' => array( '    +I - Enables known-only, any user who does not have access (at least +k)',
						   '         will be kickbanned.' ),
	// CS FLAGS OTHER
	...
	'CS_INVITE_IN_CHAN'		=>	'{nick} is already in {chan}',
	// standard messages
